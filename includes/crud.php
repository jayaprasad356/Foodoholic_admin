...
define('DOMAIN_URL', 'http://192.168.43.122/foodoholic/'); /* chnage to your domain here - don't forget to add forward slash at the end of the URL like this "/" */
define('ALLOW_MODIFICATION', 1);
define('JWT_SECRET_KEY', 'jp@0111'); /* chnage to your secret key here set it to anything you like*/
...
class Database
{
    ...
    private $db_name = "foodoholic";    // Change as required
